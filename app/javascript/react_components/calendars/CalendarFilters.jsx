    ...
    <div className='filters-container'>
      ...
      {props.teamCalendar ? (
        ...
        <div className='personal-calendar-filters'>
          <div className='filter'>
            <input key={`personal`} type='checkbox' id={`personal`} value={tempFilters.personal} checked={tempFilters.personal} onChange={handleChangedCheckbox}/>
          ...
          {props.availableFilters.teams.length > 0 && (
            <div>
              ...
              {props.availableFilters.teams.map((team, index) => (
                <div className='filter'>
                  <input key={`team${index}`} type='checkbox' id={`team${index}`} value={JSON.stringify(team)} checked={tempFilters.teams.map(team => team.id).includes(team.id)} onChange={handleChangedCheckbox}/>
